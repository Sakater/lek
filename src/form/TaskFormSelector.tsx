...
import {MappingTaskForm} from "./taskTypes/MappingTaskForm.tsx";
import {ListingTaskForm} from "./taskTypes/ListingTaskForm.tsx";
...
export function TaskFormSelector({task, open, onClose}: Props) {
    ...
    switch (task.type) {
        case TaskType.LISTING:
            return <ListingTaskForm task={task} open={open} onClose={onClose}/>;

        case TaskType.MAPPING:
            return <MappingTaskForm task={task} open={open} onClose={onClose}/>;
